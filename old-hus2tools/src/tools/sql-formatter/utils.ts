const RESERVED_KEYWORDS = new Set([
  ...
  'EXISTS', 'CASE', 'WHEN', 'THEN', 'ELSE', 'END', 'NULL', 'TRUE', 'FALSE',
  'COUNT', 'SUM', 'AVG', 'MIN', 'MAX', 'WITH', 'RECURSIVE', 'OVER',
  'PARTITION', 'ROWS', 'RANGE', 'FETCH', 'NEXT', 'ONLY', 'TOP',
